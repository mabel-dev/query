        ...
        typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
            ...
            (factory(global.Arrow = global.Arrow || {}));
                ...
                ea("Symbol", function(a) {
                    ...
                    if (a) return a;
                    c.prototype.toString = function() { return this.Gb };
                ...
                ea("Symbol.asyncIterator", function(a) { return a ? a : Symbol("Symbol.asyncIterator") });
                ...
                function l(a) { return ha(a()) }

                function ia(a) {
                    var b = a[Symbol.asyncIterator];
                    if (void 0 !== b) a = b.call(a);
                    else {
                        b = ja;
                        var c = "undefined" != typeof Symbol && Symbol.iterator && a[Symbol.iterator];
                        a = c ? c.call(a) : { next: aa(a) };
                        a = new b(a)
                    }
                    return a
                }
                ...
                function ja(a) {
                    this[Symbol.asyncIterator] = function() { return this };
                ...
                function ma() { this.La = this.U = null }
                ma.prototype.first = function() { if (this.U) return this.U.frame; throw Error("no frames in executionQueue"); };

                function na(a) { a.U && (a.U = a.U.next, a.U || (a.La = null)) }
                ma.prototype.enqueue = function(a) {
                    a = new la(a);
                    this.La ? this.La.next = a : this.U = a;
                    this.La = a
                };
                ...
                function oa(a) {
                    ...
                    this.Tb = function(c) {
                        var d = b.K.first();
                        !0 === c.done ? (b.P = null, d.method = "next", d.ea = c.value) : (d.resolve({ value: c.value, done: !1 }), na(b.K));
                        pa(b)
                    };
                    this.Sb = function(c) { qa(b, c) };
                    this.Ya = function(c) { sa(b, c) }
                }

                function ta(a, b, c) {
                    return new Promise(function(d, e) {
                        var f = null === a.K.U;
                        a.K.enqueue(new ka(b, c, d, e));
                        f && pa(a)
                    })
                }
                oa.prototype.next = function(a) { return ta(this, "next", a) };
                oa.prototype.return = function(a) { return ta(this, "return", new n(0, a)) };
                oa.prototype.throw = function(a) { return ta(this, "throw", a) };

                function pa(a) { if (null !== a.K.U) try { if (a.P) { if (!a.P) throw Error("no delegate to perform execution"); var b = a.K.first(); if (b.method in a.P) try { a.P[b.method](b.ea).then(a.Tb, a.Sb).catch(a.Ya) } catch (c) { qa(a, c) } else a.P = null, pa(a) } else ua(a) } catch (c) { sa(a, c) } }

                function ua(a) {
                    var b = a.K.first();
                    try {
                        var c = a.Ab[b.method](b.ea);
                        if (c.value instanceof n) switch (c.value.action) {
                            case 0:
                ...
                function sa(a, b) {
                    null !== a.K.U && (a.K.first().reject(b), na(a.K));
                    a.P && "return" in a.P && (a.P["return"](void 0), a.P = null);
                    a.Ab["return"](void 0);
                    pa(a)
                }
                const va = new TextDecoder("utf-8"),
                    wa = a => va.decode(a),
                    xa = new TextEncoder;
                const [, ya] = (() => {
                    function a() { throw b(); }
                    const b = () => { throw Error("BigInt is not available in this environment"); };
                    a.asIntN = () => { throw b(); };
                    a.asUintN = () => { throw b(); };
                    return "undefined" !== typeof BigInt ? [BigInt, !0] : [a, !1]
                })(), [za] = (() => {
                    const a = () => { throw Error("BigInt64Array is not available in this environment"); };
                    class b {
                    ...
                    return "undefined" !== typeof BigInt64Array ? [BigInt64Array, !0] : [b, !1]
                })(), [Aa] = (() => {
                    const a = () => { throw Error("BigUint64Array is not available in this environment"); };
                    class b {
                        static get BYTES_PER_ELEMENT() { return 8 }
                        static of() { throw a(); }
                        static from() { throw a(); }
                    ...
                    return "undefined" !== typeof BigUint64Array ? [BigUint64Array, !0] : [b, !1]
                })(), q = a => "function" === typeof a, t = a => null != a && Object(a) === a, Ba = a => "_getDOMStream" in a && "_getNodeStream" in a, Ca = a => t(a) && q(a.cancel) && q(a.getReader) && !Ba(a), Da = a => t(a) && q(a.read) && q(a.pipe) && "boolean" === typeof a.readable &&
                    !Ba(a);
                const Ea = "undefined" !== typeof SharedArrayBuffer ? SharedArrayBuffer : ArrayBuffer;

                function Fa(a) { const b = a[0] ? [a[0]] : []; let c, d, e, f; for (let g, k, m = 0, p = 0, r = a.length; ++m < r;) g = b[p], k = a[m], !g || !k || g.buffer !== k.buffer || k.byteOffset < g.byteOffset ? k && (b[++p] = k) : ({ byteOffset: c, byteLength: e } = g, { byteOffset: d, byteLength: f } = k, c + e < d || d + f < c ? k && (b[++p] = k) : b[p] = new Uint8Array(g.buffer, c, d - c + f)); return b }

                function Ga(a, b, c = 0, d = b.byteLength) {
                    const e = a.byteLength,
                        f = new Uint8Array(a.buffer, a.byteOffset, e);
                    b = new Uint8Array(b.buffer, b.byteOffset, Math.min(d, e));
                    f.set(b, c);
                    return a
                }
                ...
                function Ha(a, b) {
                    a = Fa(a);
                    const c = a.reduce((m, p) => m + p.byteLength, 0);
                    let d, e, f = 0,
                        g = -1;
                    const k = Math.min(b || Number.POSITIVE_INFINITY, c);
                    for (const m = a.length; ++g < m;) {
                        b = a[g];
                        d = b.subarray(0, Math.min(b.length, k - f));
                        if (k <= f + d.length) {
                            d.length < b.length ? a[g] = b.subarray(d.length) : d.length === b.length && g++;
                            e ? Ga(e, d, f) : e = d;
                            break
                        }
                        Ga(e || (e = new Uint8Array(k)), d, f);
                        f += d.length
                    }
                    return [e || new Uint8Array(0), a.slice(g), c - (e ? e.byteLength : 0)]
                }
                ...
                const Ia = a => { a.next(); return a };

                function* Ja(a, b) {
                    function* c(d) { yield d }
                    b = "string" === typeof b ? c(b) : ArrayBuffer.isView(b) ? c(b) : b instanceof ArrayBuffer ? c(b) : b instanceof Ea ? c(b) : t(b) && q(b[Symbol.iterator]) ? b : c(b);
                    yield* Ia(function*(d) {
                        let e = null;
                        do e = d.next(yield u(a, e)); while (!e.done)
                    }(b[Symbol.iterator]()));
                    return new a
                }
                ...
                function Ka(a, b) {
                    return new oa(function*() {
                        function c(f) {
                            return new oa(function*() {
                                yield new n(1, Ia(function*(g) {
                                    let k = null;
                                    do {
                                        let m;
                                        k = g.next(yield null == (m = k) ? void 0 : m.value)
                                    } while (!k.done)
                                }(f[Symbol.iterator]())))
                            }())
                        }

                        function d(f) { return new oa(function*() { yield new n(0, yield new n(2, f)) }()) }
                        if (t(b) && q(b.then)) return new n(0, yield new n(1, Ka(a, yield new n(2, b))));
                        const e = "string" === typeof b ? d(b) : ArrayBuffer.isView(b) ? d(b) : b instanceof ArrayBuffer ? d(b) : b instanceof Ea ? d(b) : t(b) && q(b[Symbol.iterator]) ?
                            c(b) : t(b) && q(b[Symbol.asyncIterator]) ? b : d(b);
                        yield new n(1, Ia(function(f) {
                            return new oa(function*() {
                                let g = null;
                                do g = yield new n(2, f.next(yield new n(0, u(a, g)))); while (!g.done)
                            }())
                        }(e[Symbol.asyncIterator]())));
                        return new n(0, new a)
                    }())
                }

                function La(a, b, c) { if (0 !== a) { c = c.slice(0, b + 1); for (let d = -1; ++d <= b;) c[d] += a } return c }
                ...
                var v = {};
                v.compareArrayLike = Ma;
                v.joinUint8Arrays = Ha;
                v.memcpy = Ga;
                v.rebaseValueOffsets = La;
                v.toArrayBufferView = u;
                v.toArrayBufferViewAsyncIterator = Ka;
                v.toArrayBufferViewIterator = Ja;
                v.toBigInt64Array = a => u(za, a);
                v.toBigUint64Array = a => u(Aa, a);
                v.toFloat32Array = a => u(Float32Array, a);
                v.toFloat32ArrayAsyncIterator = a => Ka(Float32Array, a);
                v.toFloat32ArrayIterator = a => Ja(Float32Array, a);
                v.toFloat64Array = a => u(Float64Array, a);
                v.toFloat64ArrayAsyncIterator = a => Ka(Float64Array, a);
                v.toFloat64ArrayIterator = a => Ja(Float64Array, a);
                v.toInt16Array = a => u(Int16Array, a);
                v.toInt16ArrayAsyncIterator = a => Ka(Int16Array, a);
                v.toInt16ArrayIterator = a => Ja(Int16Array, a);
                v.toInt32Array = a => u(Int32Array, a);
                v.toInt32ArrayAsyncIterator = a => Ka(Int32Array, a);
                v.toInt32ArrayIterator = a => Ja(Int32Array, a);
                v.toInt8Array = a => u(Int8Array, a);
                v.toInt8ArrayAsyncIterator = a => Ka(Int8Array, a);
                v.toInt8ArrayIterator = a => Ja(Int8Array, a);
                v.toUint16Array = a => u(Uint16Array, a);
                v.toUint16ArrayAsyncIterator = a => Ka(Uint16Array, a);
                v.toUint16ArrayIterator = a => Ja(Uint16Array, a);
                v.toUint32Array = a => u(Uint32Array, a);
                v.toUint32ArrayAsyncIterator = a => Ka(Uint32Array, a);
                v.toUint32ArrayIterator = a => Ja(Uint32Array, a);
                v.toUint8Array = a => u(Uint8Array, a);
                v.toUint8ArrayAsyncIterator = a => Ka(Uint8Array, a);
                v.toUint8ArrayIterator = a => Ja(Uint8Array, a);
                v.toUint8ClampedArray = a => u(Uint8ClampedArray, a);
                v.toUint8ClampedArrayAsyncIterator = a => Ka(Uint8ClampedArray, a);
                v.toUint8ClampedArrayIterator = a => Ja(Uint8ClampedArray, a);

                function Na() { throw Error('"toDOMStream" not available in this environment'); }

                function Oa() { throw Error('"toNodeStream" not available in this environment'); }
                const Pa = a => { a.next(); return a };
                ...
                function* Qa(a) {
                    let b, c = !1,
                        ...
                        e, f, g, k = 0;
                    ({ $: f, size: g } = yield null);
                    a = Ja(Uint8Array, a)[Symbol.iterator]();
                    try {
                        do
                            if ({ done: b, value: e } = Number.isNaN(g - k) ? a.next() : a.next(g - k), !b && 0 < e.byteLength && (d.push(e), k += e.byteLength), b || g <= k) {
                                do {
                                    if ("peek" === f) var m = Ha(d, g)[0];
                                    else [e, d, k] = Ha(d, g), m = e;
                                    ({ $: f, size: g } = yield m)
                                } while (g < k)
                            }
                        while (!b)
                    } catch (p) {
                        (c = !0, "function" === typeof a.throw) && a.throw(p)
                    } finally {!1 === c && "function" === typeof a.return && a.return(null) }
                    return null
                }
                ...
                function Ra(a) {
                    return new oa(function*() {
                        let b, c = !1,
                            d = [],
                            e, f, g, k = 0;
                        ({ $: f, size: g } = yield new n(0, null));
                        const m = Ka(Uint8Array, a)[Symbol.asyncIterator]();
                        try {
                            do
                                if ({ done: b, value: e } = Number.isNaN(g - k) ? yield new n(2, m.next()) : yield new n(2, m.next(g - k)), !b && 0 < e.byteLength && (d.push(e), k += e.byteLength), b || g <= k) {
                                    do {
                                        if ("peek" === f) var p = Ha(d, g)[0];
                                        else [e, d, k] = Ha(d, g), p = e;
                                        ({ $: f, size: g } = yield new n(0, p))
                                    } while (g < k)
                                }
                            while (!b)
                        } catch (r) {
                            (c = !0, "function" === typeof m.throw) && (yield new n(2, m.throw(r)))
                        } finally {
                            !1 ===
                ...
                function Sa(a) {
                    return new oa(function*() {
                        ...
                        try {
                            do
                                if ({ done: b, value: e } = Number.isNaN(g - k) ? yield new n(2, m.read()) : yield new n(2, m.read(g - k)), !b && 0 < e.byteLength && (d.push(u(Uint8Array, e)), k += e.byteLength), b || g <= k) {
                                    do {
                                        if ("peek" === f) var p = Ha(d, g)[0];
                                        else [e, d, k] = Ha(d, g), p = e;
                                        ({ $: f, size: g } = yield new n(0, p))
                            ...
                            while (!b)
                        } catch (r) { c = !0, yield new n(2, m.cancel(r)) } finally {!1 === c ? yield new n(2, m.cancel()) : a.locked && m.releaseLock() }
                        return new n(0,
                            null)
                    }())
                }
                class Ta {
                    constructor(a) {
                        this.source = a;
                        this.V = null;
                        this.V = this.source.getReader();
                        this.V.closed.catch(() => {})
                    }
                    get closed() { return this.V ? this.V.closed.catch(() => {}) : Promise.resolve() }
                    releaseLock() {
                        this.V && this.V.releaseLock();
                        this.V = null
                    }
                    cancel(a) {
                        const b = this;
                    ...
                    read(a) {
                        const b = this;
                        return l(function*() {
                            if (0 === a) return { done: null == b.V, value: new Uint8Array(0) };
                            const c = yield b.V.read();
                            !c.done &&
                                (c.value = u(Uint8Array, c));
                            return c
                        })
                    }
                }
                const Ua = (a, b) => { const c = e => d([b, e]); let d; return [b, c, new Promise(e => (d = e) && a.once(b, c))] };

                function Va(a) {
                    return new oa(function*() {
                        function b(ra, Cb) {
                            r = p = null;
                            return new Promise((Wi, Xi) => {
                                for (const [Db, Yi] of ra) a.off(Db, Yi);
                                try {
                                    const Db = a.destroy;
                                    Db && Db.call(a, Cb);
                                    Cb = void 0
                                } catch (Db) { Cb = Db || Cb } finally { null != Cb ? Xi(Cb) : Wi() }
                            })
                        }
                        const c = [];
                        let d = "error",
                            ...
                            p = [],
                            r;
                        ({ $: g, size: k } = yield new n(0, null));
                        if (a.isTTY) return yield new n(0, new Uint8Array(0)), new n(0, null);
                        try {
                            c[0] = Ua(a, "end");
                            c[1] = Ua(a, "error");
                            do {
                                c[2] = Ua(a, "readable");
                                [d, f] = yield new n(2, Promise.race(c.map(ra => ra[2])));
                                if ("error" === d) break;
                                (e = "end" === d) || (Number.isFinite(k - m) ? (r = u(Uint8Array, a.read(k - m)), r.byteLength < k - m && (r = u(Uint8Array, a.read()))) : r = u(Uint8Array, a.read()), 0 < r.byteLength && (p.push(r), m += r.byteLength));
                                if (e || k <= m) {
                                    do {
                                        if ("peek" === g) var T = Ha(p, k)[0];
                                        else [r, p, m] = Ha(p, k), T = r;
                                        ({ $: g, size: k } = yield new n(0, T))
                                    } while (k < m)
                                }
                            } while (!e)
                        } finally { yield new n(2, b(c, "error" === d ? f : null)) }
                        return new n(0, null)
                    }())
                };
                var Wa, Xa = Wa || (Wa = {});
                ...
                Xa[Xa.V5 = 4] = "V5";
                var w, Ya = w || (w = {});
                Ya[Ya.Sparse = 0] = "Sparse";
                Ya[Ya.Dense = 1] = "Dense";
                var x, Za = x || (x = {});
                Za[Za.HALF = 0] = "HALF";
                Za[Za.SINGLE = 1] = "SINGLE";
                Za[Za.DOUBLE = 2] = "DOUBLE";
                var $a, ab = $a || ($a = {});
                ab[ab.DAY = 0] = "DAY";
                ab[ab.MILLISECOND = 1] = "MILLISECOND";
                var y, bb = y || (y = {});
                bb[bb.SECOND = 0] = "SECOND";
                bb[bb.MILLISECOND = 1] = "MILLISECOND";
                bb[bb.MICROSECOND = 2] = "MICROSECOND";
                bb[bb.NANOSECOND = 3] = "NANOSECOND";
                var cb, db = cb || (cb = {});
                db[db.YEAR_MONTH = 0] = "YEAR_MONTH";
                db[db.DAY_TIME = 1] = "DAY_TIME";
                db[db.MONTH_DAY_NANO = 2] = "MONTH_DAY_NANO";
                var z, eb = z || (z = {});
                eb[eb.NONE = 0] = "NONE";
                eb[eb.Schema = 1] = "Schema";
                eb[eb.DictionaryBatch = 2] = "DictionaryBatch";
                eb[eb.RecordBatch = 3] = "RecordBatch";
                eb[eb.Tensor = 4] = "Tensor";
                eb[eb.SparseTensor = 5] = "SparseTensor";
                var A, B = A || (A = {});
                B[B.NONE = 0] = "NONE";
                B[B.Null = 1] = "Null";
                B[B.Int = 2] = "Int";
                ...
                B[B.Utf8 = 5] = "Utf8";
                B[B.Bool = 6] = "Bool";
                B[B.Decimal = 7] = "Decimal";
                B[B.Date = 8] = "Date";
                B[B.Time = 9] = "Time";
                B[B.Timestamp = 10] = "Timestamp";
                B[B.Interval = 11] = "Interval";
                B[B.List = 12] = "List";
                B[B.Struct = 13] = "Struct";
                B[B.Union = 14] = "Union";
                B[B.FixedSizeBinary = 15] = "FixedSizeBinary";
                B[B.FixedSizeList = 16] = "FixedSizeList";
                B[B.Map = 17] = "Map";
                B[B.Dictionary = -1] = "Dictionary";
                B[B.Int8 = -2] = "Int8";
                B[B.Int16 = -3] = "Int16";
                B[B.Int32 = -4] = "Int32";
                B[B.Int64 = -5] = "Int64";
                ...
                B[B.Uint32 = -8] = "Uint32";
                B[B.Uint64 = -9] = "Uint64";
                B[B.Float16 = -10] = "Float16";
                B[B.Float32 = -11] = "Float32";
                B[B.Float64 = -12] = "Float64";
                B[B.DateDay = -13] = "DateDay";
                B[B.DateMillisecond = -14] = "DateMillisecond";
                B[B.TimestampSecond = -15] = "TimestampSecond";
                B[B.TimestampMillisecond = -16] = "TimestampMillisecond";
                B[B.TimestampMicrosecond = -17] = "TimestampMicrosecond";
                B[B.TimestampNanosecond = -18] = "TimestampNanosecond";
                B[B.TimeSecond = -19] = "TimeSecond";
                B[B.TimeMillisecond = -20] = "TimeMillisecond";
                B[B.TimeMicrosecond = -21] = "TimeMicrosecond";
                B[B.TimeNanosecond = -22] = "TimeNanosecond";
                B[B.DenseUnion = -23] = "DenseUnion";
                B[B.SparseUnion = -24] = "SparseUnion";
                B[B.IntervalDayTime = -25] = "IntervalDayTime";
                B[B.IntervalYearMonth = -26] = "IntervalYearMonth";
                var fb, gb = fb || (fb = {});
                gb[gb.OFFSET = 0] = "OFFSET";
                gb[gb.DATA = 1] = "DATA";
                gb[gb.VALIDITY = 2] = "VALIDITY";
                gb[gb.TYPE = 3] = "TYPE";
                ...
                function hb(a) {
                    ...
                    return "function" === typeof a[Symbol.toPrimitive] ? a[Symbol.toPrimitive]("string") : ArrayBuffer.isView(a) ? a instanceof BigInt64Array || a instanceof BigUint64Array ? `[${[...a].map(b=>hb(b))}]` : `[${a}]` : ArrayBuffer.isView(a) ? `[${a}]` : JSON.stringify(a, (b, c) => "bigint" === typeof c ? `${c}` : c)
                };
                const ib = Symbol.for("isArrowBigNum");

                function jb(a, ...b) { return 0 === b.length ? Object.setPrototypeOf(u(this.TypedArray, a), this.constructor.prototype) : Object.setPrototypeOf(new this.TypedArray(a, ...b), this.constructor.prototype) }
                jb.prototype[ib] = !0;
                jb.prototype.toJSON = function() { return `"${kb(this)}"` };
                jb.prototype.valueOf = function() { return lb(this) };
                jb.prototype.toString = function() { return kb(this) };
                jb.prototype[Symbol.toPrimitive] = function(a = "default") {
                    switch (a) {
                        case "number":
                            return lb(this);
                        case "default":
                ...
                function nb(...a) { return jb.apply(this, a) }

                function ob(...a) { return jb.apply(this, a) }

                function pb(...a) { return jb.apply(this, a) }
                Object.setPrototypeOf(nb.prototype, Object.create(Int32Array.prototype));
                Object.setPrototypeOf(ob.prototype, Object.create(Uint32Array.prototype));
                Object.setPrototypeOf(pb.prototype, Object.create(Uint32Array.prototype));
                Object.assign(nb.prototype, jb.prototype, { constructor: nb, signed: !0, TypedArray: Int32Array, BigIntArray: za });
                Object.assign(ob.prototype, jb.prototype, { constructor: ob, signed: !1, TypedArray: Uint32Array, BigIntArray: Aa });
                Object.assign(pb.prototype, jb.prototype, { constructor: pb, signed: !0, TypedArray: Uint32Array, BigIntArray: Aa });

                function lb(a) {
                    const { buffer: b, byteOffset: c, length: d, signed: e } = a;
                    a = new Aa(b, c, d);
                    const f = e && a[a.length - 1] & BigInt(1) << BigInt(63);
                    let g = f ? BigInt(1) : BigInt(0),
                        k = BigInt(0);
                    if (f) {
                        for (const m of a) g += ~m * (BigInt(1) << BigInt(32) * k++);
                        g *= BigInt(-1)
                    } else
                        for (const m of a) g += m * (BigInt(1) << BigInt(32) * k++);
                    return g
                ...
                let kb, mb;
                ya ? (mb = a => 8 === a.byteLength ? (new a.BigIntArray(a.buffer, a.byteOffset, 1))[0] : qb(a), kb = a => 8 === a.byteLength ? `${(new a.BigIntArray(a.buffer,a.byteOffset,1))[0]}` : qb(a)) : mb = kb = qb;

                function qb(a) {
                    let b = "";
                    const c = new Uint32Array(2);
                    a = new Uint16Array(a.buffer, a.byteOffset, a.byteLength / 2);
                    const d = new Uint32Array((a = (new Uint16Array(a)).reverse()).buffer);
                    let e;
                    const f = a.length - 1;
                    do {
                        for (c[0] = a[e = 0]; e < f;) a[e++] = c[1] = c[0] / 10, c[0] = (c[0] - 10 * c[1] << 16) + a[e];
                        a[e] = c[1] = c[0] / 10;
                        c[0] -= 10 * c[1];
                        b = `${c[0]}${b}`
                ...
                class rb {
                    static new(a, b) {
                        ...
                        return 16 === a.byteLength ? new pb(a) : new ob(a)
                    }
                    static cc(a) { return new nb(a) }
                    constructor(a, b) { return rb.new(a, b) }
                }
                var sb = {};
                sb.BN = rb;
                sb.bignumToBigInt = mb;
                sb.bignumToString = kb;
                sb.isArrowBigNumSymbol = ib;
                class C {
                    static isNull(a) { return (null == a ? void 0 : a.typeId) === A.Null }
                    static isInt(a) { return (null == a ? void 0 : a.typeId) === A.Int }
                    static isFloat(a) { return (null == a ? void 0 : a.typeId) === A.Float }
                    static isBinary(a) { return (null == a ? void 0 : a.typeId) === A.Binary }
                    static isUtf8(a) { return (null == a ? void 0 : a.typeId) === A.Utf8 }
                    static isBool(a) { return (null == a ? void 0 : a.typeId) === A.Bool }
                    static isDecimal(a) { return (null == a ? void 0 : a.typeId) === A.Decimal }
                    static isDate(a) { return (null == a ? void 0 : a.typeId) === A.Date }
                    static isTime(a) {
                        return (null ==
                            a ? void 0 : a.typeId) === A.Time
                    }
                    static isTimestamp(a) { return (null == a ? void 0 : a.typeId) === A.Timestamp }
                    static isInterval(a) { return (null == a ? void 0 : a.typeId) === A.Interval }
                    static isList(a) { return (null == a ? void 0 : a.typeId) === A.List }
                    static isStruct(a) { return (null == a ? void 0 : a.typeId) === A.Struct }
                    static isUnion(a) { return (null == a ? void 0 : a.typeId) === A.Union }
                    static isFixedSizeBinary(a) { return (null == a ? void 0 : a.typeId) === A.FixedSizeBinary }
                    static isFixedSizeList(a) { return (null == a ? void 0 : a.typeId) === A.FixedSizeList }
                    static isMap(a) {
                        return (null ==
                            a ? void 0 : a.typeId) === A.Map
                    }
                    static isDictionary(a) { return (null == a ? void 0 : a.typeId) === A.Dictionary }
                    static isDenseUnion(a) { return C.isUnion(a) && a.mode === w.Dense }
                    static isSparseUnion(a) { return C.isUnion(a) && a.mode === w.Sparse }
                    get typeId() { return A.NONE }
                }
                var tb = Symbol.toStringTag,
                    ub, vb = C.prototype;
                vb.children = null;
                vb.ArrayType = Array;
                ub = vb[Symbol.toStringTag] = "DataType";
                C[tb] = ub;
                class wb extends C {
                    toString() { return "Null" }
                    get typeId() { return A.Null }
                }
                ...
                var yb = Symbol.toStringTag,
                    zb, Ab = xb.prototype;
                Ab.isSigned = null;
                Ab.bitWidth = null;
                zb = Ab[Symbol.toStringTag] = "Int";
                xb[yb] = zb;
                class Bb extends xb {
                    constructor() { super(!0, 8) }
                    get ArrayType() { return Int8Array }
                }
                class Eb extends xb {
                    constructor() { super(!0, 16) }
                ...
                class Hb extends xb {
                    constructor() { super(!1, 8) }
                    get ArrayType() { return Uint8Array }
                }
                class Ib extends xb {
                    constructor() { super(!1, 16) }
                    get ArrayType() { return Uint16Array }
                }
                class Jb extends xb {
                    constructor() { super(!1, 32) }
                    get ArrayType() { return Uint32Array }
                }
                class Kb extends xb {
                    constructor() { super(!1, 64) }
                    get ArrayType() { return BigUint64Array }
                }
                Object.defineProperty(Bb.prototype, "ArrayType", { value: Int8Array });
                Object.defineProperty(Eb.prototype, "ArrayType", { value: Int16Array });
                Object.defineProperty(Fb.prototype, "ArrayType", { value: Int32Array });
                Object.defineProperty(Gb.prototype, "ArrayType", { value: BigInt64Array });
                Object.defineProperty(Hb.prototype, "ArrayType", { value: Uint8Array });
                Object.defineProperty(Ib.prototype, "ArrayType", { value: Uint16Array });
                Object.defineProperty(Jb.prototype, "ArrayType", { value: Uint32Array });
                Object.defineProperty(Kb.prototype, "ArrayType", { value: BigUint64Array });
                class Lb extends C {
                    constructor(a) {
                        super();
                        this.precision = a
                    }
                    get typeId() { return A.Float }
                    get ArrayType() {
                ...
                var Mb = Symbol.toStringTag,
                    Nb, Ob = Lb.prototype;
                Ob.precision = null;
                Nb = Ob[Symbol.toStringTag] = "Float";
                Lb[Mb] = Nb;
                class Pb extends Lb { constructor() { super(x.HALF) } }
                class Qb extends Lb { constructor() { super(x.SINGLE) } }
                class Rb extends Lb { constructor() { super(x.DOUBLE) } }
                Object.defineProperty(Pb.prototype, "ArrayType", { value: Uint16Array });
                Object.defineProperty(Qb.prototype, "ArrayType", { value: Float32Array });
                Object.defineProperty(Rb.prototype, "ArrayType", { value: Float64Array });
                class Sb extends C {
                    constructor() { super() }
                    get typeId() { return A.Binary }
                    toString() { return "Binary" }
                }
                var Tb = Symbol.toStringTag,
                    Ub, Vb = Sb.prototype;
                Vb.ArrayType = Uint8Array;
                Ub = Vb[Symbol.toStringTag] = "Binary";
                Sb[Tb] = Ub;
                class Wb extends C {
                    constructor() { super() }
                    get typeId() { return A.Utf8 }
                    toString() { return "Utf8" }
                }
                var Xb = Symbol.toStringTag,
                    Yb, Zb = Wb.prototype;
                Zb.ArrayType = Uint8Array;
                Yb = Zb[Symbol.toStringTag] = "Utf8";
                Wb[Xb] = Yb;
                class $b extends C {
                    constructor() { super() }
                    get typeId() { return A.Bool }
                    toString() { return "Bool" }
                }
                var ac = Symbol.toStringTag,
                    bc, cc = $b.prototype;
                cc.ArrayType = Uint8Array;
                bc = cc[Symbol.toStringTag] = "Bool";
                $b[ac] = bc;
                class dc extends C {
                    constructor(a, b, c = 128) {
                        super();
                        this.scale = a;
                        this.precision = b;
                        this.bitWidth = c
                    }
                    get typeId() { return A.Decimal }
                    toString() { return `Decimal[${this.precision}e${0<this.scale?"+":""}${this.scale}]` }
                }
                var ec = Symbol.toStringTag,
                    fc, gc = dc.prototype;
                gc.scale = null;
                gc.precision = null;
                gc.ArrayType = Uint32Array;
                fc = gc[Symbol.toStringTag] = "Decimal";
                dc[ec] = fc;
                class hc extends C {
                    constructor(a) {
                        super();
                    ...
                    get typeId() { return A.Date }
                    toString() { return `Date${32*(this.unit+1)}<${$a[this.unit]}>` }
                }
                var ic = Symbol.toStringTag,
                    jc, kc = hc.prototype;
                kc.unit = null;
                kc.ArrayType = Int32Array;
                jc = kc[Symbol.toStringTag] = "Date";
                hc[ic] = jc;
                class lc extends hc { constructor() { super($a.DAY) } }
                class mc extends hc { constructor() { super($a.MILLISECOND) } }
                class nc extends C {
                    constructor(a, b) {
                        super();
                        this.unit = a;
                    ...
                    get typeId() { return A.Time }
                    toString() { return `Time${this.bitWidth}<${y[this.unit]}>` }
                    get ArrayType() {
                        switch (this.bitWidth) {
                            case 32:
                                return Int32Array;
                ...
                var oc = Symbol.toStringTag,
                    pc, qc = nc.prototype;
                qc.unit = null;
                qc.bitWidth = null;
                pc = qc[Symbol.toStringTag] = "Time";
                nc[oc] = pc;
                class rc extends nc { constructor() { super(y.SECOND, 32) } }
                class sc extends nc { constructor() { super(y.MILLISECOND, 32) } }
                class tc extends nc { constructor() { super(y.MICROSECOND, 64) } }
                class uc extends nc { constructor() { super(y.NANOSECOND, 64) } }
                class vc extends C {
                    constructor(a, b) {
                        super();
                        this.unit = a;
                    ...
                    get typeId() { return A.Timestamp }
                    toString() { return `Timestamp<${y[this.unit]}${this.timezone?`, ${this.timezone}`:""}>`}}var wc=Symbol.toStringTag,xc,yc=vc.prototype;yc.unit=null;yc.timezone=null;yc.ArrayType=Int32Array;xc=yc[Symbol.toStringTag]="Timestamp";
